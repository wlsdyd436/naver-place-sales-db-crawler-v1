...
# 1개만 처리한다. 브라우저/context/page의 생성·소유·teardown 책임은 이번
# 단계에 없다(실제 브라우저를 소유하는 context manager는 WIRE-2B에서
# 구현 예정). 이 모듈은 브라우저를 직접 launch하지 않으므로 live 실행 없이
# FakePage 주입만으로 검증할 수 있다.
#
