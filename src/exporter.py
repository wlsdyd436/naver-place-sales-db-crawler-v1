...
MERGED_COLUMNS = [
    ...
    "플레이스 URL",
    "수집일",
    # 2026-07-06 Stage 3C: 단일 스키마 확장. 기존 8개 컬럼의 이름/순서/위치는 그대로
    # 두고, PC full 엔진이 수집하는 온라인 채널 컬럼만 맨 뒤에 append 한다. 이 필드가
    # 없는 행(모바일/기존 흐름)은 _rows_with_columns의 get(col, "")로 빈칸이 된다.
    "홈페이지",
    "인스타",
    "블로그",
]
